...
const EXACT_KEY_MAP: Record<string, string> = {
  ...
  AUTH_INVALID_BROWSER_KEY: "server.auth.invalidBrowserKey",
  AUTH_GUEST_REENTRY_BLOCKED: "server.auth.guestReentryBlocked",
  AUTH_GUEST_SCOPE_MISMATCH: "server.auth.guestScopeMismatch",
