        ...
        <section className="flex items-center gap-3 rounded-xl border border-[color:var(--page-theme-border-primary)] bg-[color:var(--page-theme-surface-primary)] px-3 py-2">
          ...
          <div className="flex w-20 shrink-0 justify-end">
            <select
              ...
              className="h-8 w-full min-w-0 rounded-lg border border-[color:var(--page-theme-border-primary)] bg-[color:var(--page-theme-surface-secondary)] pl-2 pr-1.5 py-1.5 text-xs font-medium text-[color:var(--page-theme-text-primary)] outline-none"
            >
